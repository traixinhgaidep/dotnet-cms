...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.language = 'vi';
    config.filebrowserBrowserUrl = '/Areas/Admin/Content/plugins/ckfinder/ckfinder.html';
    config.filebrowserImageBrowserUrl = '/Areas/Admin/Content/plugins/ckfinder/ckfinder.html?Type=Images';
    config.filebrowserFlashBrowserUrl = '/Areas/Admin/Content/plugins/ckfinder/ckfinder.html?Type=Flash';
